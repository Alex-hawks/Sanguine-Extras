...
public class Constants
{
    ...
    public static final class SacrificeLP
    {
        public static final int VILLAGER = 2000;
        public static final int SLIME    = 150;
        public static final int ENDERMAN = 200;
        public static final int ANIMAL   = 250;
        public static final int MOB      = 500;
    }
}
