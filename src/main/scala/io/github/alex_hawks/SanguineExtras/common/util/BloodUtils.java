...
{
    public static boolean drainSoulNetwork(@Nullable UUID owner, int amount, @Nullable EntityPlayer user)
    {
        if (user == null)
    ...
    public static boolean drainSoulNetworkWithDamage(@Nullable UUID owner, int amount, @Nonnull EntityPlayer user)
    {
        ...
        SoulNetwork n = owner == null ? null : NetworkHelper.getSoulNetwork(owner);
    ...
    {
        return RitualRegistry.getRitualForId(name);
    }
